  ...
  skillCategories: [
    {
      ...
      items: [
        { text: "Anforderungsanalyse", level: 5 },
        { text: "Projektsetup mit Git", level: 5 },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Models used more intensively",
          items: [
    ...
    },
    {
      ...
      items: [
        { text: "Node.js, Bun, Deno", level: 5 },
        { text: "Express", level: 5 },
        { text: "Elysia", level: 3 },
        { text: "RESTful Architektur", level: 5 },
        { text: "Event Driven Design", level: 4 },
        { text: "WebSockets: plain und mit tRPC", level: 5 },
        { text: "Drizzle ORM + Drizzle Kit", level: 5 },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Progressive Web Apps", level: 4 },
    ...
    },
    {
      title: "CI/CD & DevOps",
      items: [
        { text: "Buddy.Works", level: 4 },
        { text: "GitLab Pipelines", level: 5 },
        { text: "GitHub Actions", level: 5 },
        { text: "Jenkins", level: 4 },
        { text: "Docker Compose", level: 5 },
        { text: "Ansible", level: 4 },
      ],
    },
    {
      ...
      items: [
        { text: "Jira", level: 4 },
        { text: "GitLab Boards", level: 4 },
        { text: "KanBoard", level: 4 },
        { text: "Scrum", level: 5 },
        { text: "Confluence", level: 5 },
        { text: "Markdown", level: 5 },
        { text: "Excalidraw", level: 5 },
    ...
    },
    {
      ...
      items: [
        { text: "nginx", level: 3 },
        { text: "Deno Deploy", level: 4 },
        {
          text: "AWS Cloud (EC2, VPC, EKS, RDS, IAM, Lambda, API Gateway)",
          level: 3,
        },
        { text: "Railway", level: 4 },
        { text: "Linux-Server (Ubuntu, Debian, Alpine)", level: 5 },
        { text: "Traefik", level: 5 },
        { text: "Nextcloud", level: 4 },
        { text: "Vaultwarden", level: 5 },
        { text: "Plex", level: 4 },
        { text: "Netcup, Hetzner, do.de, hosting.de", level: 5 },
      ],
    },
  ],
  projects: [
  ...
  skillCategories: [
    {
      title: "Project Setup",
      items: [
        { text: "Requirements analysis", level: 5 },
        { text: "Project setup with Git", level: 5 },
        {
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Express", level: 5 },
        { text: "Elysia", level: 3 },
        { text: "RESTful architecture", level: 5 },
        { text: "Event-driven design", level: 4 },
        { text: "Websockets: plain and with tRPC", level: 5 },
        { text: "Drizzle ORM + Drizzle Kit", level: 5 },
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Railway", level: 4 },
        { text: "Linux servers (Ubuntu, Debian, Alpine)", level: 5 },
        { text: "Traefik", level: 5 },
        { text: "Nextcloud", level: 4 },
        { text: "Vaultwarden", level: 5 },
        { text: "Plex", level: 4 },
